...
const Showcase = () => {
  const allProducts = [
    { id: "p1", name: "Velvet Handbags", category: "Bag", price: "₹6200", instock: true },
    { id: "p2", name: "Rose Gold Perfume", category: "Perfume", price: "₹3500", instock: true },
    { id: "p3", name: "Parisian Scarf", category: "Scarf", price: "₹2400", instock: false },
    { id: "p4", name: "Classic Watch", category: "Watch", price: "₹7200", instock: true },
    { id: "p5", name: "Luxury Hat", category: "Hat", price: "₹4300", instock: true },
    { id: "p6", name: "Silk Gloves", category: "Gloves", price: "₹1500", instock: true },
  ];
  ...
  const categories = ['All', 'Bag', 'Perfume', 'Scarf', 'Watch', 'Hat', 'Gloves'];
    ...
    <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-gradient-to-b from-pink-50 to-rose-100'} min-h-screen p-6`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {filteredProducts.map((product) => (
          <div
            key={product.id}
            className={`rounded-xl p-6 shadow-lg transition duration-300 transform hover:scale-105 cursor-pointer ${
        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-white rounded-xl p-8 max-w-sm w-full shadow-xl relative">
            ...
            <p className="text-sm font-poppins text-gray-500">
              This exclusive item is part of the luxury Saifarle collection, handpicked for your elegance.
            </p>
          </div>
        </div>
      )}
